...
const String fSignup = "SingUp";
const String fEmail = "E-Mail";
const String fFullName = "Full Name";
...
const String fAppTagLine = "Store All Data \n In One Place.";

//welcome screen text
const fWelcomeTitle = "Welcome to mxpert";
const tWelcomeSubTitle = "View, add, delete and update your data ";

//Login Screen Text
const String fLoginTitle = "Welcome Back";
const String fLoginSubTitle = "Make it work, make it right, make it fast";
const String fRememberMe = "Remember me?";
const String fDontHaveAnAccount = "Don't have an Account?";
